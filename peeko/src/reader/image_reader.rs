...
async fn load_manifest<P: AsRef<Path>>(image_dir: P) -> anyhow::Result<ImageManifest> {
...
pub async fn build_image_reader<P: AsRef<Path>>(image_dir: P) -> anyhow::Result<ImageReader> {
